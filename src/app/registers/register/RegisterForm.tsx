...
const RegisterForm = () => {
  ...
  const [pets, setPets] = useState([{ nome: '', raca: '', especie: '' }]);
  ...
  const handleAddPet = () => {
    setPets([...pets, { nome: '', raca: '', especie: '' }]);
  };
        ...
        <div className='mb-10'>
          ...
          {pets.map((pet, index) => (
            <div key={index} className='flex-col gap-4 '>
              <div className='flex flex-col'>
                <label htmlFor={`petNome${index}`} className='text-lg font-semibold'>Nome do pet:</label>
                <input
                  type="text"
                  name={`petNome${index}`}
              ...
              <div className='flex flex-col'>
                <label htmlFor={`petRaca${index}`} className='text-lg font-semibold'>Raça do pet:</label>
                <input
                  type="text"
                  name={`petRaca${index}`}
                  className="input input-bordered h-3/4 pt-2 pb-2 text-lg"
              ...
              <div className='flex flex-col'>
                <label htmlFor={`petEspecie${index}`} className='text-lg font-semibold'>Espécie do pet:</label>
                <select
                  name={`petEspecie${index}`}
                  className="input input-bordered h-3/4 pt-2 pb-2 text-lg"
                  value={pet.especie}
                  onChange={(e) => handlePetChange(index, 'especie', e.target.value)}
                >
